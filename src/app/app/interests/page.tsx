...
// The consolidated interest workbench (PER-228 follow-up): the standalone
// /app/chat page is gone — interest docs live in a fixed-width LEFT rail and a
// clean, full-height chat fills the ENTIRE right-hand pane. Below 1024px the
// page collapses to a single chat column with a Chat|Docs segmented toggle;
// on small screens Docs opens as a bottom-sheet.
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1">
        {/* Desktop interests rail (≥1024px): fixed-width LEFT column with a
            hairline divider; the chat owns everything to its right. */}
        <aside className="hidden min-h-0 w-[34%] min-w-[340px] max-w-[440px] overflow-y-auto border-r border-border-default lg:block">
          {rail}
        </aside>

        {/* Chat pane — fills the entire right-hand side. On tablet (md–lg) the
            toggle swaps panes inline; on mobile chat stays the base layer
